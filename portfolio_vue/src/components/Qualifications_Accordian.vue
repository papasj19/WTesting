...
<template>
  ...
  <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-gray-900 text-gray-900 dark:text-white" data-inactive-classes="text-gray-500 dark:text-gray-400">
    ...
    <div id="accordion-flush-body-1" class="data-active-classes" aria-labelledby="accordion-flush-heading-1">
    ...
    <div id="accordion-flush-body-2" class="data-active-classes" aria-labelledby="accordion-flush-heading-2">
      <div class="py-5 border-b border-gray-200 dark:border-gray-700">
    ...
    <div id="accordion-flush-body-3" class="data-active-classes" aria-labelledby="accordion-flush-heading-3">
      <div class="py-5 border-b border-gray-200 dark:border-gray-700">
